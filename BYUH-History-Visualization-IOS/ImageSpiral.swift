...
//    static var screenHeight: CGFloat = 100
    ...
    static var theta: CGFloat = 4550

    static var startYearTest: String = ""
    static var endYearTest: String = ""
    
    static var templeYears: Array<String> = Array<String>()
    static var templeYearsThetaFriends: Array<CGFloat> = [60, 80, 100, 160, 220, 250, 280, 310, 360, 390, 420, 540, 600, 630, 740, 770, 830, 860, 920, 970, 1000, 1060, 1090, 1120, 1180, 1230, 1260, 1380, 1410, 1440, 1530, 1560, 1580, 1610, 1640, 1730, 1760, 1830, 1870, 1960, 2190, 2270, 2360, 2690, 2840, 3240, 3610, 3910, 4130, 4400]
